...
if(checkCommandResult(
  execSync('node dist/src/index.js -e test').toString('utf-8'),
  'dGVzdA=='
)){
...
if(checkCommandResult(
  execSync('node dist/src/index.js -e -i test/in-love-small.png').toString('utf-8'),
...
if(checkCommandResult(
  execSync('node dist/src/index.js -d -i test/hello-world.txt.b64').toString('utf-8'),
  'Hello World!'
)){
  console.log(chalk.green('TEST Success !'));
} else {
...
execSync('node dist/src/index.js -d  -o test/decodedImage.tmp.png');
...
execSync('node dist/src/index.js -e "Hello World" -o test/encoded.tmp.txt.b64');
...
if(execSync('node dist/src/index.js -e --html -i test/in-love-small.png').toString('utf8') === fs.readFileSync('./test/html-image-output.html').toString('utf8')+'\n'){
  console.log(chalk.green('TEST Success !'));
} else {
  console.log(chalk.red('TEST Failed !')); 
  errorCount ++;
...
execSync('node dist/src/index.js -e --html -i test/in-love-small.png -o test/image.tmp.html');
...
execSync('node dist/src/index.js -e -i test/bus.gif -o test/encoded.tmp.gif');
